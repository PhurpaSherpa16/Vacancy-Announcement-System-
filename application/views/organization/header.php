    ...
    <link rel="stylesheet" id="main-stylesheet" data-version="1.1.0" href="<?php echo base_url();?>assets/custom/styles/shards-dashboards.1.1.0.min.css">
    <link rel="stylesheet" href="<?php echo base_url();?>assets/custom/styles/extras.1.1.0.min.css">
    ...
    <script src="<?php echo base_url();?>assets/custom/scripts/extras.1.1.0.min.js"></script>
    <script src="<?php echo base_url();?>assets/custom/scripts/shards-dashboards.1.1.0.min.js"></script>
    <script src="<?php echo base_url();?>assets/custom/scripts/app/app-blog-overview.1.1.0.js"></script>
    ...
    <script src="<?php echo base_url();?>assets/js/proper.min.js"></script>
    <script src="<?php echo base_url();?>assets/js/jquery-3.1.js"></script>
