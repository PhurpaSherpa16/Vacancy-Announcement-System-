            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="card card-small mb-4 pt-3">
                  ...
                  <div class="mb-2">
                    <span style="padding: 20px;"><a href="<?php echo base_url();?>Organization/companyupdate">Update</a> Company details or Your Post !!!</span>
                  </div>
                </div>
              </div>
                ...
                <div class="card card-small mb-4">
                  ...
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item p-3">
                      <div class="row">
                        <div class="col">
                          <form method="post" action="<?php echo base_url();?>OrganizationRole/profileupdate">
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <input type="text" value="<?php echo $userdata->uid;?>" name="uid" hidden>
                                <label for="feFirstName">First Name</label>
                                <input type="text" class="form-control" id="feFirstName" name="firstname" placeholder="First Name ***" value="<?php echo $userdata->firstname;?>">
                                <span id="f_error"></span>
                              </div>
                              <div class="form-group col-md-6">
                                <label for="feLastName">Last Name</label>
                                <input type="text" class="form-control" id="feLastName" name="lastname" placeholder="Last Name ***" value="<?php echo $userdata->lastname;?>">
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="number">Phone</label>
                                <input type="number" class="form-control" name="number" id="number" placeholder="Number **" value="<?php echo $userdata->number;?>"> 
                            ...
                            <div class="form-row">
                              <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" name="description" rows="5" placeholder="Define your function in organization"><?php echo $userdata->description;?></textarea>
                              </div>
                            </div>
