              ...
              <ul class="navbar-nav border-left flex-row ">
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle mr-2" src="<?php echo base_url();?>assets/images/admin.png?>" alt="User Avatar" style="height: 40px; width: 70px;">
                    <span class="d-none d-md-inline-block"><?php echo $userdata->firstname. ' '. $userdata->lastname ?></span>
                  </a>
                  <div class="dropdown-menu dropdown-menu-small">
                    <a class="dropdown-item" href="<?php echo base_url();?>Admin/showProfile">
