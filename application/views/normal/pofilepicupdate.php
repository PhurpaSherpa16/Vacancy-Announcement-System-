          ...
          <div class="container" role="alert">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Add Profile Picture</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <!-- Default Light Table -->
                ...
                <div class="card card-small mb-4">
                  ...
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item p-3">
                      <div class="row">
                        <div class="col">
                          <form method="post"  action="<?php echo base_url();?>NormalRole/updateProfilePic" enctype="multipart/form-data">
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-10">
                                  <?php if (isset($normaldata->image)) {
                                    ?>
                                       <img class="user-avatar rounded-circle mr-2" src="<?php echo base_url();?>assets/images/<?php echo $normaldata->image?>" alt="User Avatar" style="height: 400px; width: 400px;">
                                    <?php
                                }
                                else{
                                  ?>
                            ...
                            <button type="submit" class="btn btn-accent">Update Picture</button>
                          </form>
                        </div>
                      </div>
                    </li>
